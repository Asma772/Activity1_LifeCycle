...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.button:
                Toast toast  = Toast.makeText(MainActivity.this, "First Button Pressed", Toast.LENGTH_LONG);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast toast  = Toast.makeText(MainActivity.this, "First:onCreate()", Toast.LENGTH_LONG);
    ...
    protected void onStart() {
        ...
        //make toast to have a visual as to which callback is currently called
        Toast toast  = Toast.makeText(MainActivity.this, "First:onStart()", Toast.LENGTH_LONG);
    ...
    protected void onRestart() {
        ...
        //make toast to have a visual as to which callback is currently called
        Toast toast  = Toast.makeText(MainActivity.this, "First:onRestart()", Toast.LENGTH_LONG);
    ...
    protected void onResume() {
        ...
        //make toast to have a visual as to which callback is currently called
        Toast toast  = Toast.makeText(MainActivity.this, "First:onResume()", Toast.LENGTH_LONG);
    ...
    protected void onPause() {
        ...
        //make toast to have a visual as to which callback is currently called
        Toast toast  = Toast.makeText(MainActivity.this, "First:onPause()", Toast.LENGTH_LONG);
    ...
    protected void onStop() {
        ...
        //make toast to have a visual as to which callback is currently called
        Toast toast  = Toast.makeText(MainActivity.this, "First:onStop()", Toast.LENGTH_LONG);
